# 🏰 Sistema SG-SST — Edificio Avalon

**NIT:** 800245101-1  
**Dirección:** Calle 65 #9-07  
**Email:** edificioavalonadm@gmail.com  
...
2. Agrega usuario con correo: **edificioavalonadm@gmail.com**
...
```bash
# Desde la carpeta sst-avalon/
git init
git add .
git commit -m "Sistema SG-SST Edificio Avalon inicial"
git remote add origin https://github.com/edificioavalon/sst-avalon.git
git push -u origin main
```

Luego en GitHub: Settings → Pages → Branch: main → / (root) → Save

**URL del sistema:** `https://edificioavalon.github.io/sst-avalon/`
